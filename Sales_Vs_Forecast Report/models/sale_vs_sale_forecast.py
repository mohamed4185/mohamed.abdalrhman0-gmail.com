...
class sale_vs_forecast(models.Model):
    ...
    def _get_date_format(self):
        ...
        forcast_search=self.env['forecast.product'].search(['&',('sales_person','=',self.salesman_id.id),('product_id','=',self.product_id.id)])
        ...
        order_line=self.env['sale.order.line'].search(['&',('salesman_id','=',self.salesman_id.id),('product_id','=',self.product_id.id)])
...
class sale_vs_forecast(models.Model):
    ...
    def search_report(self):
        ...
        'target': 'current',
         'domain':"[('id','in',%s)]"%(ids),
         'context':{'group_by':['salesman_id','product_id']},
