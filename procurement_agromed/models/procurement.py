...
class ProcurementGroup2(models.Model):
    '''
    ...
    '''
    _name = 'procurement.group2'
    _description = 'Procurement Requisition'
    _order = "id desc"

    name = fields.Char(
        'Reference',
        default=lambda self: self.env['ir.sequence'].next_by_code('procurement.group2') or '',
        required=True)
...
class ProcurementRule(models.Model):
    ...
    group_id = fields.Many2one('procurement.group2', 'Fixed Procurement Group')
...
class ProcurementOrder(models.Model):
    ...
    group_id = fields.Many2one('procurement.group2', 'Procurement Group')
